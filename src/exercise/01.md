...
Javascript code as `<script type="module">` helps to create different files doing different things and keeping them organized.
With this type of script it's possible to:
- create a module to do a specific thing and separate functions semantically
- import and export functions to be used by other files
- insert JS code inside `<script>` tag
